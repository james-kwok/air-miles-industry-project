import "../YourOffers/YourOffers.scss";
    ...
    return (
        <section className="your-offer">
            ...
            <div className="card">
                ...
                <div className="card__info-container">
                    <div className="card__picture">
                        <img className="card__hm" src={americanEagle} alt=""></img>
                    </div>
                    <div className="card__text-info-container">
                        <p className="card__cash-value">200 Bonus miles for every 50$</p>
                        <p className="card__info-text">Winter collection purchased on online. Visit www.ae.com/ca/</p>
                        <p className="card__end-date">Ends in 6 days</p>
                    </div>
                </div>
                <div className="card__info-container">
                    <div className="card__picture">
...
export default NewYourOfferRemoved;